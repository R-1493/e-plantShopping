...
import { addItem } from "./CartSlice"; // Ensure to import addItem
...
function ProductList({ onHomeClick }) {
  ...
  const handleContinueShopping = () => {
    setShowCart(false); // Hide the cart to go back to the product list
  };
  ...
  const handleCartClick = (e) => {
    e.preventDefault();
    setShowCart(true); // Show cart when cart icon is clicked
  };
